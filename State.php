...
<span>
        <input type="text" name="StateName" placeholder="State" class="form-control mb-3" required>
</span>
         <button class="btn btn-success mt-3" name="addState">Add</button>
</form>
    </div>
  </div>
<?php
    ...
    <div class="card h-100">
      <div class="card-body">
        <h5 class="card-title"><?php echo $rows['StateName']; ?></h5>
      </div>
    </div>
  </div>
